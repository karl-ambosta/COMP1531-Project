...
def dashboard():
    ...
    return render_template("dashboard.html", review = database.get_survey_of_status('review'), active = database.get_survey_of_status('active'), closed = database.get_survey_of_status('closed'))
